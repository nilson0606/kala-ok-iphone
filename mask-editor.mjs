...
export function createMaskEditor(options) {
  ...
  function render() {
    ...
    $('mask-song').textContent = reference ? `${reference.title} · ${reference.separationModel === 'bs-roformer' ? 'BS-RoFormer' : 'Demucs'} · ${reference.vocalMode === 'lead' ? '主唱模式' : '一般人聲'} · 基準長度 ${formatMaskTime(reference.duration)}` : '尚未載入歌曲基準。';
