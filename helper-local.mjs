...
async function health() {
  ...
  pending = (async () => {
    ...
    cache = { app: 'karaoke-local-helper', version: 1, features: ['library', 'stem-preview', 'library-location'], ready: Object.values(checks).every(Boolean), checks, audioUpload: false };
