...
def main():
    ...
    # Karaoke receives a vocal stem; BS-RoFormer receives the original mix.
    # Their identical internal stem names therefore have different meanings.
    separator.separate(str(args.input), stems)
